...
Tags: woocommerce,payment gateway, woocommerce extension, bpm payment,payment, payment option, custom payment
...
2. Search for 'WooCommerce bpm Payment Gateway'
3. Click 'Install Now'
...
3. Select `woocommerce-bpm-payment-gateway.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `woocommerce-bpm-payment-gateway.zip`
2. Extract the `woocommerce-bpm-payment-gateway` directory to your computer
3. Upload the `woocommerce-bpm-payment-gateway` directory to the `/wp-content/plugins/` directory
